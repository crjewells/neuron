...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp2SynNMDA /Users/christopherjewell/Desktop/USC/Research/J4 Morphology/hoc/nmdaSyn.mod\n");
...
double vspom ( _threadargsprotocomma_ double _lv ) {
   double _lvspom;
 _lvspom = 1. / ( 1. + 0.25 * extMgConc * exp ( alpha_vspom * ( _lv - v0_block ) ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/christopherjewell/Desktop/USC/Research/J4 Morphology/hoc/nmdaSyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  ...
  "	e=0	(mV)\n"
  "	eca = 100 (mV)\n"
  "	alpha_vspom = -0.08 (/mV) :-0.062, -0.075: -0.0602: -0.08: -0.062  :voltage-dependence of Mg2+ block from Maex and De Schutter 1998\n"
  ...
  "\n"
  "FUNCTION vspom (v(mV))( ){\n"
  "	vspom=1./(1.+0.25*extMgConc*exp(alpha_vspom*(v-v0_block))) :voltage-dependence of Mg2+ block from Maex and De Schutter 1998\n"
  "	:vspom=1./(1.+0.2439*extMgConc*exp(alpha_vspom*(v-v0_block))) : K0-1 = 0.2439 from Spruston et al. (1995) (Ching-Lung) 0.2801\n"
  "}\n"
  ;
#endif
