...
g_index = int(np.floor(id/100)) # Determines which g_inhib value to use
trial = id % 100 + 1            # Establishes trial number
...
amp_adj = [1.1, 1.275, 1.425, 1.5750000000000002, 1.75, 1.875, 2.0, 2.175, 2.2750000000000004, 2.4000000000000004, 2.55, 2.6500000000000004, 2.8, 2.875, 3.0, 3.125]
...
filename = "fs-collection/group" + str(g_index) + "-trial" + str(trial) + ".csv"
